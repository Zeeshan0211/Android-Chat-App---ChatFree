...
import com.FireBase.Maju.chatingApp.core.login.LoginContract;
import com.FireBase.Maju.chatingApp.core.login.LoginPresenter;
import com.FireBase.Maju.chatingApp.ui.activities.RegisterActivity;
import com.FireBase.Maju.chatingApp.ui.activities.UserListingActivity;
...
public class LoginFragment extends Fragment implements View.OnClickListener, LoginContract.View {
    ...
    private void onLogin(View view) {
        ...
        if (emailId.equals(""))
        {
            mETxtEmail.setError("Please Enter Your Email");
            return;
        }
        else if (password.equals(""))
        {
            mETxtPassword.setError("Please Enter Your Password");
            return;
        }
