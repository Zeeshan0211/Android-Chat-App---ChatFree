package com.FireBase.Maju.chatingApp.core.chat;

import android.content.Context;
import android.util.Log;

import com.FireBase.Maju.chatingApp.fcm.FcmNotificationBuilder;
import com.FireBase.Maju.chatingApp.models.Chat;
import com.FireBase.Maju.chatingApp.utils.Constants;
import com.FireBase.Maju.chatingApp.utils.SharedPrefUtil;
...
public class ChatInteractor implements ChatContract.Interactor {
    ...
    public void getMessageFromFirebaseUser(String senderUid, String receiverUid) {
        ...
        databaseReference.child(Constants.ARG_CHAT_ROOMS).getRef().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public DatabaseError fromException(Throwable e){

                return DatabaseError.fromException(e);
            }
